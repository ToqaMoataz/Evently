...
import '../../Features/Event%20Management/Domain/Use%20cases/get_curr_langlat_usecase.dart'
    as _i822;
import '../../Features/Event%20Management/Presentation/Cubit/View%20Models/event_creation_view_model.dart'
    as _i226;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i37.EventManagementDS>(() => _i37.EventManagementDSImp());
    gh.factory<_i341.EventManagementRepo>(
      () => _i311.EventManagementRepoImp(gh<_i37.EventManagementDS>()),
    );
    ...
    gh.factory<_i226.EventCreationViewModel>(
      () => _i226.EventCreationViewModel(
