...
import '../../Features/Event%20Management/Domain/Use%20cases/update_event_usecase.dart'
    as _i805;
import '../../Features/Event%20Management/Presentation/Cubit/View%20Model/event_form_view_model.dart'
    as _i801;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i980.FaveTabDS>(
      () => _i980.FaveTabRemoteDSImp(),
      instanceName: 'remote',
    );
    gh.factory<_i691.CommonLocalDS>(() => _i691.SharedLocalDSIMP());
    gh.factory<_i998.ProfileRemoteDs>(() => _i998.ProfileRemoteDsImp());
    gh.factory<_i980.FaveTabDS>(
      () => _i980.FaveTabLocalDSImp(),
      instanceName: 'local',
    );
    gh.factory<_i526.HomeScreenDS>(
      () => _i526.HomeScreenLocalDSImp(),
      instanceName: 'local',
    );
    ...
    gh.factory<_i3.HomeTabDS>(
      () => _i3.HomeTabRemoteDSImp(),
      instanceName: 'remote',
    );
    ...
    gh.factory<_i526.HomeScreenDS>(
      () => _i526.HomeScreenRemoteDSImp(),
      instanceName: 'remote',
    );
    gh.factory<_i3.HomeTabDS>(
      () => _i3.HomeTabLocalDSImp(),
      instanceName: 'local',
    );
    ...
    gh.factory<_i153.HomeRepo>(() => _i993.HomeRepoImp(
          gh<_i3.HomeTabDS>(instanceName: 'remote'),
          gh<_i3.HomeTabDS>(instanceName: 'local'),
        ));
    gh.factory<_i868.GetEventsUC>(
        () => _i868.GetEventsUC(gh<_i153.HomeRepo>()));
    gh.factory<_i1038.HomeScreenRepo>(() => _i534.HomeScreenRepoImp(
          gh<_i526.HomeScreenDS>(instanceName: 'remote'),
          gh<_i526.HomeScreenDS>(instanceName: 'local'),
        ));
    gh.factory<_i1022.ProfileLocalRepo>(
        () => _i873.ProfileLocalRepoImp(gh<_i736.ProfileLocalDs>()));
    gh.factory<_i183.FavRepo>(() => _i597.FaveTabRepoImp(
          gh<_i980.FaveTabDS>(instanceName: 'remote'),
          gh<_i980.FaveTabDS>(instanceName: 'local'),
        ));
    ...
    gh.factory<_i538.UploadUserImageUC>(() => _i538.UploadUserImageUC(
          gh<_i334.ProfileRemoteRepo>(),
          gh<_i1022.ProfileLocalRepo>(),
        ));
    gh.factory<_i911.ProfileViewModel>(() => _i911.ProfileViewModel(
    ...
    gh.factory<_i667.FavViewModel>(() => _i667.FavViewModel(
    ...
    gh.factory<_i351.HomeTabViewModel>(() => _i351.HomeTabViewModel(
    ...
    gh.factory<_i801.EventFormViewModel>(() => _i801.EventFormViewModel(
    ...
    gh.factory<_i60.MapTabViewModel>(() => _i60.MapTabViewModel(
